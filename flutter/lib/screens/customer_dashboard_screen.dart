...
class _MemberDashboardScreenState extends State<MemberDashboardScreen> {
  late Future<CustomersResponse> memberFuture;
  DateTime? _lastBackPress;

  @override
  void initState() {
    super.initState();
    memberFuture = ApiService().getCustomers(limit: 1);
  }
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      body: FutureBuilder<CustomersResponse>(
        future: memberFuture,
        builder: (context, snapshot) {
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 12),
                  ElevatedButton(
                    onPressed: () => setState(() { memberFuture = ApiService().getCustomers(limit: 1); }),
          ...
          final members = snapshot.data?.customers ?? [];
          if (members.isEmpty) {
            return const Center(child: Text('No customer profile found'));
          }
            ...
            child: Column(
              ...
              children: [
                ...
                _DetailCard(
                  ...
                  title: 'Days Until Subscription End',
                  value: member.daysUntilSubscriptionEnd > 0
                      ? '${member.daysUntilSubscriptionEnd} days'
                      : 'Expired',
                  color: member.daysUntilSubscriptionEnd <= 7 ? Colors.red : Colors.orange,
                ),
                const SizedBox(height: 12),
                _DetailCard(
                ...
                _DetailCard(
                  ...
                  value: member.subscriptionEndDate.toString().split(' ')[0],
                  color: Colors.teal,
                ),
                const SizedBox(height: 12),
                _DetailCard(
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    onPressed: () {
                      ...
                      AppUiHelper().showModernSnackBar(context, message: 'Renew Plan request sent to business owner');
